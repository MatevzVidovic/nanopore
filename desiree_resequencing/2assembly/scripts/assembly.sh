...
# !!! hifiasm version 
#Hifiasm-0.25.0-r726
asm_version=12_fixed
out_dir=/scratch/evakrzisnik/desiree_resequencing/assembly/outputs/$asm_version
threads=40
# create out dir
mkdir $out_dir
...
#cat \
#/scratch/evakrzisnik/desiree_resequencing/reads_qc/inputs/library2.fastq \
#/scratch/evakrzisnik/desiree_resequencing/reads_qc/inputs/timg_desiree.fastq \
#> /DKED/scratch/evakrzisnik/desiree_resequencing/assembly/inputs/mergedlibraries.fastq
...
"""
    ...
    /scratch/evakrzisnik/desiree_resequencing/assembly/inputs/mergedlibraries.fastq \
    /scratch/timg/desiree_seq/output/reads/desiree_hifi_raw.fastq \
    --h1 /scratch/timg/desiree_asm/data/hic/desiree_hic_raw_R1.fastq.gz \
    --h2 /scratch/timg/desiree_asm/data/hic/desiree_hic_raw_R2.fastq.gz \
    --hom-cov 95 \
    --n-hap 4 \
    -s 0.45 \
    --n-perturb 20000 \
